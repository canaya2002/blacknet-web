            ...
            <Link href={`/blog/${featured.slug}`} className="group block">
              <GlowCard>
                <div className="grid grid-cols-1 gap-8 p-8 md:grid-cols-2 md:p-10">
                  <div className="aspect-video overflow-hidden rounded-xl border border-[color:var(--color-border)] bg-[color:var(--color-bg-secondary)]">
                    <div
              ...
              <Link href={`/blog/${post.slug}`} className="group block h-full">
                <GlowCard className="h-full">
                  <div className="flex h-full flex-col gap-4 p-6">
                    <div
                      className="aspect-video w-full rounded-lg border border-[color:var(--color-border)] bg-[color:var(--color-bg-secondary)]"
                      style={{
                        background:
